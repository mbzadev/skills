# Mode de vérification/contrôle pour `setup-matt-pocock-skills`

Ce projet n'ajoutera pas de mode dédié de vérification/contrôle (ou une skill de vérification séparée) pour `setup-matt-pocock-skills`.
...
- #106 — Demande de fonctionnalité : mode de vérification/contrôle pour setup-matt-pocock-skills
