---
name: to-tickets
description: "Divisez un plan, une spécification ou la conversation en cours en tickets de type balle traçante, chacun déclarant ses dépendances, puis publiez-les dans l’outil configuré : un fichier par ticket en local ou des liens de blocage natifs dans un véritable outil de suivi."
---

# Créer des tickets

Divisez un plan, une spécification ou une conversation en **tickets** constituant chacun une tranche verticale de type balle traçante et déclarant les autres tickets qui le **bloquent**.

Le vocabulaire du suivi des tickets et des étiquettes de triage devrait déjà être disponible. Dans le cas contraire, exécutez `/setup-matt-pocock-skills`.
...
Divisez le travail en tickets de type **balle traçante**.
...
- Toute préfactorisation doit être effectuée en premier
...
Publiez les tickets approuvés selon l’outil configuré par `/setup-matt-pocock-skills`. Leur contenu reste identique ; seule la représentation des dépendances change :
